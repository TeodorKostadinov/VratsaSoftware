...
{   
    public class CmTeachersController : Controller
    {
        ...
        {
            return View(context.CmTeachers.Include(cmteacher => cmteacher.cmUser).Include(cmteacher => cmteacher.clUniversity).ToList());
        }
        ...
        {
            ViewBag.PossiblecmUsers = context.CmUsers;
